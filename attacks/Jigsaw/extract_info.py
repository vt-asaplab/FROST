...
def get_all_for_attacks(
    ...
    if similar_data_p == None:
        sim_doc = total_doc[:(int) (len(total_doc)/3)]
        real_doc = total_doc[(int) (len(total_doc)/3):]
    else:
        sim_doc = total_doc[:(int) (len(total_doc)*similar_data_p)]
        real_doc = total_doc[(int) (len(total_doc)*similar_data_p):]
    ...
    query_freq_all_dict = {}
    for i in range(observe_weeks):
        if countermeasure_params["alg"] == "osse" or countermeasure_params["alg"] == "frost":
            f = np.ones(len(user_kws_universe)) / len(user_kws_universe)
        else:
    ...
    elif countermeasure_params["alg"] == "clrz":
        real_query_d = obfuscate_CLRZ(real_query_d,countermeasure_params["p"],countermeasure_params["q"],countermeasure_params["m"])
    elif countermeasure_params["alg"] == "osse":
        real_query_d = obfuscate_OSSE(real_query_d,countermeasure_params["p"],countermeasure_params["q"],countermeasure_params["m"])
    elif countermeasure_params["alg"] == "frost":
        real_query_d = obfuscate_FROST(real_query_d,countermeasure_params["p"],countermeasure_params["q"],countermeasure_params["m"])
...
def get_all_for_attacks_wiki(
    ...
    if similar_data_p == None:
        sim_doc_kwsid = doc_kwsid[:(int) (len(doc_kwsid)/3)]
        real_doc_kwsid = doc_kwsid[(int) (len(doc_kwsid)/3):]
    else:
        sim_doc_kwsid = doc_kwsid[:(int) (len(doc_kwsid)*similar_data_p)]
        real_doc_kwsid = doc_kwsid[(int) (len(doc_kwsid)*similar_data_p):]
