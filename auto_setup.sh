...
echo "export CLASSPATH=$PREFIX/others/Clusion/target:$PREFIX/others/Clusion/target/test-classes:$PREFIX/others/Clusion/target/classes:$PREFIX/others/Clusion/target/Clusion-1.0-SNAPSHOT-jar-with-dependencies.jar:\$CLASSPATH" >> /home/$USER/.bashrc
