...
- Wait for the initialization process to complete, then enter a keyword to perform a search (e.g., "university"). When keyword search is complete, it outputs processing latency and bandwidth overhead of keyword search for the true positive rate TPR = 0.95 w.r.t various false positive rates FPR = {0.025, 0.05, 0.1, 0.15, 0.2}. 
